...
func (i *i18nMiddleware) Serve(ctx context.Context) {
	wasByCookie := false
...
func (i *i18nMiddleware) logf(ctx context.Context, format string, args ...interface{}) {
	ctx.Application().Logger().Debugf(format, args...)
}

// NewI18nMidddleware returns a new i18n middleware
func NewI18nMidddleware(c i18nConfig) context.Handler {
