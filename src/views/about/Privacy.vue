<template>
  <el-card>
    ...
    <h3>适用范围</h3>
    <ol>
      <li>在您注册本应用帐号时，您根据本应用要求提供的个人注册信息；</li>
      <li>在您使用本应用网络服务，或访问本应用平台网页时，本应用自动接收并记录的您的浏览器和设备上的信息，包括但不限于您的IP地址、浏览器的类型、使用的语言、访问日期和时间、软硬件特征信息及您需求的网页记录等数据；</li>
      <li>本应用通过合法途径从商业伙伴处取得的用户个人数据。</li>
    </ol>
    <p>您了解并同意，以下信息不适用本隐私权政策：</p>
    <ol>
      <li>您在使用本应用平台提供的搜索服务时输入的关键字信息；</li>
      <li>本应用收集到的您在本应用发布的有关信息数据，包括但不限于参与活动、搜索记录等详情；</li>
      <li>违反法律规定或违反本应用规则行为及本应用已对您采取的措施。</li>
    </ol>
    <h3>信息使用</h3>
    <ol>
    ...
    <ol>
      ...
      <li>如您出现违反中华人民共和国有关法律、法规或者本应用服务协议或相关规则的情况，需要向第三方披露；</li>
    ...
    <h3>本隐私政策的更改</h3>
    <ol>
      <li>如果决定更改隐私政策，我们会在本政策中、本中心网站中以及我们认为适当的位置发布这些更改，以便您了解我们如何收集、使用您的个人信息，哪些人可以访问这些信息，以及在什么情况下我们会透露这些信息。</li>
      <li>本中心保留随时修改本政策的权利，因此请经常查看。如对本政策作出重大更改，本中心会通过网站通知的形式告知。</li>
    </ol>
  </el-card>
</template>
